...
export const scrollToArea = (area) => {
    ...
    document.readyState === 'complete' ?
        setTimeout(() => {
            ...
            if (documentRef) documentRef.scrollIntoView({ behavior: 'smooth', block: "center" })
...
export const handleRoutes = (option, type) => {
    ...
    if (type === 'services' || type === 'projects') {
        ...
        const optionToTest = slashTesting ? optionLowerCase.split("/")[0] : clickedOption.startsWith('graphic') ? optionLowerCase.split(" ")[1] : optionLowerCase
